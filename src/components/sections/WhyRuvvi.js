const BENEFITS = [
  ...
  {
    title: "Discreet",
    description: "Sits comfortably under the lip. Nobody knows it\u2019s there.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
  ...
  {
    title: "Portable",
    description: "Pocket-sized tin. Take it anywhere, use it anytime.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-3 sm:mt-16 sm:grid-cols-2 sm:gap-4 lg:grid-cols-3">
          {BENEFITS.map((benefit) => (
            <div
              key={benefit.title}
              className="rounded-2xl bg-white/10 p-6 transition-all hover:bg-white/15 sm:rounded-3xl sm:p-8"
            >
